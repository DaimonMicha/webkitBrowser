...
PortManager *BrowserApplication::s_portManager = 0;
    ...
    , m_localServer(0)
{
    ...
    QCoreApplication::setApplicationName(QLatin1String("webkitBrowser"));
    QCoreApplication::setApplicationVersion(QLatin1String("1.0.3"));
#ifdef Q_WS_QWS
    ...
    QMessageBox::information(0, "Webkit Browser",
...
void BrowserApplication::postLaunch()
{
    ...
    BrowserApplication::portManager();
    ...
    if(canRestoreSession()) {
        ...
        if (m_mainWindows.count() > 1) {
            // delete first MainWindow
            QPointer<BrowserMainWindow> wnd = m_mainWindows.takeLast();
            wnd->deleteLater();
        }
    }
}
...
PortManager *BrowserApplication::portManager()
{
    if (!s_portManager) {
        s_portManager = new PortManager();
    }
